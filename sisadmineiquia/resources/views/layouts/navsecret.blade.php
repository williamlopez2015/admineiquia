...
<<<<<<< HEAD
                   <li>
                        <a href="/admin/empleado/create"><i class="glyphicon glyphicon-user"></i> Agregar Empleado</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul id="demo1" class="collapse">
                    <li>
                        <a href="/admin/asistencia/create"><i class="glyphicon glyphicon-pencil"></i> Agregar Asistencia</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul id="demo2" class="collapse">
                    <li>
                        <a href="/admin/permiso/create"><i class="glyphicon glyphicon-ok"></i> Agregar Permiso</a>
                    </li>
                    <li>
                        <a href="/admin/permiso"><i class="glyphicon glyphicon-file"></i> Gestionar Permisos</a>
                    </li>
                </ul>
            </li>
=======
