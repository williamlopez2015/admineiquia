    ...
    <li>
        <a href="#" data-toggle="collapse" data-target="#demo3"><i class="fa fa-fw fa-paperclip"></i> Gestionar Permisos Expediente <i class="fa fa-angle-left pull-right"fa fa-angle-left pull-right></i></a>
    ...
    <li>
        <a href="#" data-toggle="collapse" data-target="#demo4"><i class="fa fa-fw fa-paperclip"></i> Gestionar de Acuerdo<i class="fa fa-angle-left pull-right"></i></a>
