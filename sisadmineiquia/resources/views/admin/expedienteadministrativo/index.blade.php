...
@section('contenido')
                ...
                <div class="row">
                <div class="col-lg-12">
                <label><a href="{{url('/admin/expedienteadministrativo/create')}}" class="btn btn-primary btn-lg" role="button"><i class="fa fa-plus"></i> Nuevo Expediente Administrativo</a></label>
                <!--
