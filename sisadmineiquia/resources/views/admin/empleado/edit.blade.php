 ...
 <div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="form-group">
            	...
            	<input type="text" name="segundonombre" class="form-control" value="{{$empleado->SEGUNDONOMBRE}}" placeholder="Segundo Nombre..." id="segundonombre" onkeyup="corregirSegundoNombre();">
